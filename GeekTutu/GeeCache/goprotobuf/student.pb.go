...
type Student struct {
	...
	Name   string  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // = 后面的数字是标识符，每个字段都需要唯一的标识符。标识各个字段
	Male   bool    `protobuf:"varint,2,opt,name=male,proto3" json:"male,omitempty"`
	Scores []int32 `protobuf:"varint,3,rep,packed,name=scores,proto3" json:"scores,omitempty"` // repeated 表示可重复，在 go 中是数组类型
}
